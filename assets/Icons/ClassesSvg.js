  ...
  return (
    <View style={[{ alignItems: 'center', justifyContent: 'center' }]}>
      ...
      >
        ...
        <Path
          fill={props.color}
          d='m34 10.382v11.236l11.236-5.618zm2 3.236 4.764 2.382-4.764 2.382z'
        />
        <Path
          fill={props.color}
        ...
        />
        <Path fill={props.color} d='m30 41h6v2h-6z' />
        <Path fill={props.color} d='m30 45h4v2h-4z' />
        <Path fill={props.color} d='m30 37h6v2h-6z' />
        <Path fill={props.color} d='m19 13h2v2h-2z' />
        <Path fill={props.color} d='m57 25h2v2h-2z' />
        <Path fill={props.color} d='m57 21h2v2h-2z' />
        <Path fill={props.color} d='m57 17h2v2h-2z' />
        <Path fill={props.color} d='m21 7h8v-2h-8c-1.103 0-2 .897-2 2v4h2z' />
      </Svg>
    </View>
  );
};
