...
//  StemTree
//
//  Created by syed akbar on 14/07/2025.
//
...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getVariantURL) {
   return @"https://stemtreev2-lms.calimatic.com";
}
...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(pass) {
  return @{ @"PRIMARY_COLOR" :  @"#0287c0",
            @"PRIMARY_TEXT_COLOR":@"#0287c0",
            @"DAY_1" :  @"#7396C9",
            @"DAY_2" :  @"#56CCC9",
            @"DAY_3" :  @"#81D3AA",
            @"DAY_4" :  @"#779CFC",
