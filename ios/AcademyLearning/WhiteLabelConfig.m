...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getVariantName) {
  return @"academylearning";
}

RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getVariantURL) {
   return @"https://portal.academy-learning.com";
}
  ...
  RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(getGreetingText) {
    return @"Your Kids Deserve the Best";
  }
...
RCT_EXPORT_BLOCKING_SYNCHRONOUS_METHOD(pass) {
  return @{ @"PRIMARY_COLOR" :  @"#004BC0",
            ...
            @"ACTIVE_STUDENT" : @"#548235",
            @"ACTIVE_STUDENT_BG" : @"#a3ba47",
            @"QUICK_LINK_1":@"#87CEEB",
            @"QUICK_LINK_2":@"#41B3A3",
            @"QUICK_LINK_3":@"#6BB1E1",
            @"QUICK_LINK_4":@"#B8D7A3",
            ...
            @"CHAT_INTERFACE_CHAT_LEFT" :  @"#D3DEF4",
