...
const UserProfile = () => {
  ...
  const { roleName, fullName, userImag, userName, firstName, lastName, email ,businessCompanyGuid, companyUrl} =
  ...
  return (
    ...
    >
      <_View style={styles.container}>
        ...
        {isEnabled("Connect to Social Media") &&<Pressable
            onPress={() => {
            ...
            style={{width:200, height: 35,
              ...
              alignItems: 'center',}}
          >
            <_Text style={styles.changePasswordTxt}>Connect to Social Media</_Text>
          </Pressable>}
      </_View>
      <ChangePasswordModal
